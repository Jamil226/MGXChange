...
import com.app.trendize.databinding.ActivityAddProductToGetLoanBinding;
...
public class AddProductToGetLoan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBinding = ActivityAddProductToGetLoanBinding.inflate(getLayoutInflater());
        ...
        mBinding.tvProductTerms.setOnClickListener(viewTvProductTermsListener -> {
            ...
            builder.setMessage("- By accepting our offer you agree that your valuable(s) will be used as collateral for a short-term loan.\n" +
                    ...
                    "- MGXCHANGE offer 30 days short term loan, repayment of loaned amount plus 24% interest is required to be paid on or before the repayment set date, a grace period of 3 days is given, please be advised once loan repayment set date and grace period has elapsed, no negotiation will be entered into, therefore your valuable(s) will be defaulted, become property of MGXCHANGE, whereas repayment extension can be made, provided interest on loaned amount is paid on or before due date.\n" +
...
//            }
                ...
                Call<UserAddLoanProductResponse> call = RetrofitClient
                        .getInstance()
                        .getApi()
                ...
                call.enqueue(new Callback<UserAddLoanProductResponse>() {
                    ...
                    public void onResponse(Call<UserAddLoanProductResponse> call,
                                           Response<UserAddLoanProductResponse> response) {
                    ...
                    @Override
                    public void onFailure(Call<UserAddLoanProductResponse> call,
                                          Throwable t) {
                        progressDialog.dismiss();
