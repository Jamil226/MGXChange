...
import com.app.trendize.activities.ItemListDetails;
import com.app.trendize.models.Products;
import com.app.trendize.utils.ApiUrls;
...
public class UserActiveSellProductsAdapter
        extends RecyclerView.Adapter<UserActiveSellProductsAdapter.ViewHolder> {

    private final LayoutInflater mInflater;
    Context context;
    private List<Products> mData =  new ArrayList<>();

    public UserActiveSellProductsAdapter(Context context, List<Products> data) {
